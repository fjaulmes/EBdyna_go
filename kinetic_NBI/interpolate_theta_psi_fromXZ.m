...
%limited map range
alphas_pos_x=min(alphas_pos_x,scale_X(end-1));
alphas_pos_z=min(alphas_pos_z,scale_Z(end-1));
alphas_pos_x=max(alphas_pos_x,scale_X(1));
alphas_pos_z=max(alphas_pos_z,scale_Z(1));
    

Xindex_precise=(alphas_pos_x/DX)+mid_X;
