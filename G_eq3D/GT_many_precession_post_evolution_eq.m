...
TPRECISE=2;
TIME_STAMP_PRECISION=20;
RECORD_PRECISION=TIME_STAMP_PRECISION*5;
...
INPUTNAME='alphas_vA5_collapse_Glisa_fc0p8h2_G160414.mat'
SAVENAME='G_alphas_precession_final5.mat';

% INPUTNAME='initial_flat_distribution.mat'
% SAVENAME='G_800keV_flat_precession.mat';
...
%         estimate_half_time_step_positions_eq_G;
        ...
        pos_X_gc=(mHe/eV)*(1/ZHe)*(v_Z.*bphi-alphas_Rpos.*v_phi.*bZ)./alphas_Bfield;
        pos_Z_gc=(mHe/eV)*(1/ZHe)*(alphas_Rpos.*v_phi.*bX-v_X.*bphi)./alphas_Bfield;
...
SAVENAME=strcat('final_eq_',SAVENAME)
if SAVE_DATA_FILE==1
