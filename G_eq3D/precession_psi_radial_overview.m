...
PRECESS_RADIAL_BIN_SIZE=0.06;
precession_radial_bins=(0:PRECESS_RADIAL_BIN_SIZE:19*PRECESS_RADIAL_BIN_SIZE);
radial_values=(0.5*PRECESS_RADIAL_BIN_SIZE:PRECESS_RADIAL_BIN_SIZE:18.5*PRECESS_RADIAL_BIN_SIZE);
...
plot(radial_values,radial_values*0+1,'y--','LineWidth',2);
plot([r_value_q1_mean r_value_q1_mean],[-1 max(max(radial_precess_value(1:end-1,:)))],'y--','LineWidth',2);
xlim([radial_values(1) radial_values(end-1)])
ylim([min(min(radial_precess_value(1:end-1,:))) max(max(radial_precess_value(1:end-1,:)))])
...
plot(radial_values,radial_precess_value(:,4),'r','LineWidth',4);
plot(radial_values,radial_values*0+1,'y--','LineWidth',2);
plot([r_value_q1_mean r_value_q1_mean],[-2 max(max(radial_precess_value(1:end-1,:)))],'y--','LineWidth',2);
xlim([radial_values(1) radial_values(end-1)])
ylim([min(min(radial_precess_value(1:end,:))) max(max(radial_precess_value(1:end,:)))])
