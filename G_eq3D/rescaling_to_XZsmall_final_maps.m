...
%     lap_B_XZsmall_map(:,:)=lap_B(Xinf:Xsup,Zinf:Zsup);
    ...
    q_final_XZsmall_map=zeros(size_X,size_Z);
    q_final_XZsmall_map(:,:)=psi_norm_XZsmall_map(:,:);
    q_final_XZsmall_map=interp1(1:257,q_final, q_final_XZsmall_map,'*linear');
