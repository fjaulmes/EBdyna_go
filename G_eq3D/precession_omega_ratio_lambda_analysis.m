...
precession_lambda_bins=(0:PRECESS_LAMBDA_BIN_SIZE:60*PRECESS_LAMBDA_BIN_SIZE);
lambda_values=(0.5*PRECESS_LAMBDA_BIN_SIZE:PRECESS_LAMBDA_BIN_SIZE:59.5*PRECESS_LAMBDA_BIN_SIZE);
...
for Ebin=1:(length(precession_Ekin_bins)-1)
    ...
    for bin=1:(length(precession_lambda_bins)-1)
        ...
        lambda_precess_value(bin,Ebin)=(mean(abs(omega_precess_avg(PRECESS_LAMBDA_POP))/mean(abs(omega_psi_avg(PRECESS_LAMBDA_POP)))));
%         lambda_precess_value(bin,Ebin)=(mean(abs(omega_precess_avg(PRECESS_LAMBDA_POP))./abs(omega_psi_avg(PRECESS_LAMBDA_POP)))));
    end
end
