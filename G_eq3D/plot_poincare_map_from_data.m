...
for n=1:128
    ...
    figure(1);
    plot(theta_outputG(n,TORPOSLOOP),psi_value_outputG(n,TORPOSLOOP),'.','color',[0 0 0.5])
%     plot(theta_outputG(n,TORPOSLOOP),psi_value_outputG(n,TORPOSLOOP),'b.')
%     plot(theta_outputG(n,TORPOSLOOP),-pphi_recalc_outputG(n,TORPOSLOOP),'b.')
    ...
    if POLOIDAL_PLOT==1
        ...
        plot(Rvalues,Zvalues,'.','color',[0 0 0.7])
    end
end
