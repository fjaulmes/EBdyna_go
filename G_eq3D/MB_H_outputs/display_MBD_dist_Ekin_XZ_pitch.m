...
E_BIN_SIZE=1*1e3;
E_BINS=(-E_BIN_SIZE:E_BIN_SIZE:32*1e3);
...
contourf ( E_values,pitch_values, mHistpost'/max(max(mHist)),(0 :0.05:1));
% plot([-1 1],[X_axis X_axis],'k--','Linewidth',4)
colorbar
...
% mHistpost(1,1)=0;
% 
% contourf ( pitch_values, E_values,mHistpost-mHist,(-100 :5:100));
% %plot2Dhist(mHist,PITCH_BINS,E_BINS,   'pitch',  'r (m)','Nb part ini'); 
% axis  ij
% xlabel('pitch')
% ylabel('Ekin')
