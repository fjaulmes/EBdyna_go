...
SAVENAME='./initial_NBI60kev_pre_collapse_all.mat'

n=1;
INPUTNAME=strcat('initial_NBI60kev_',num2str(n),'pre_collapse.mat')
load(INPUTNAME)
...
save(SAVENAME,'mHe', 'ZHe','Nalphas_simulated','alphas_Ekin','alphas_mm', 'alphas_pphi0', 'pos_X_gc','pos_Z_gc','alphas_pos_x', 'alphas_pos_z', 'alphas_pos_phi', 'alphas_vpll', 'alphas_psi', 'v_X', 'v_Z', 'v_phi');
...
%%
% precession stats
SAVENAME='./initial_NBI60kev_precession_stats_all.mat'

n=1;
INPUTNAME=strcat('initial_NBI60kev_',num2str(n),'precession_stats.mat')
load(INPUTNAME)
% r_avg=r_avg';
...
SAVENAME='./NBI60kev_fc2h1_all.mat'

n=1;
INPUTNAME=strcat('NBI60kev_fc2h1_',num2str(n),'.mat')
load(INPUTNAME)
