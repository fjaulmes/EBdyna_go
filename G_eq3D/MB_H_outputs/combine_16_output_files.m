...
SAVENAME='./MB_D_fc1p6h1p6_all.mat'

n=1;
INPUTNAME=strcat('MB_D_fc1p6h1p6_',num2str(n),'.mat')
load(INPUTNAME)
...
save(SAVENAME,'alphas_Ekin', 'alphas_mm', 'alphas_pphi0', 'alphas_pos_x', 'alphas_pos_z', 'alphas_pos_phi', 'alphas_vpll', 'alphas_psi', 'alphas_ejected',  'alphas_psi_value_corr',  'time', 'frame_rank_precise', 'alphas_omega', 'alphas_Etot', 'pos_X_gc', 'pos_Z_gc');
