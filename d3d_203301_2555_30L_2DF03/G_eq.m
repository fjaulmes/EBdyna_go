...
par.SAVENAME             = [folders.GEQ_OUTPUT,'full_FIDASIM_markers_D3D.mat'];
par.DISTNAME             = [folders.GEQ_INPUT,'FIDASIM_markers_5k.mat'];
par.VESSEL_FILENAME      = [folders.DATA_COMMON_TOKAMAK,'RZ_wall.mat'];
