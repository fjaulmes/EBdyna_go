...
SAVENAME='./initial_MB_H250_pre_collapse_all.mat'

n=1;
INPUTNAME=strcat('initial_MB_H250_pre_collapse',num2str(n),'.mat')
load(INPUTNAME)
...
%%
% precession stats
SAVENAME='./initial_MB_H250_precession_stats_all.mat'

n=1;
INPUTNAME=strcat('initial_MB_H250_precession_stats',num2str(n),'.mat')
load(INPUTNAME)
% r_avg=r_avg';
