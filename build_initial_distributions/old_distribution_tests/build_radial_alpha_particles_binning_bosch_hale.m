...
%radial range
pTAE_inf=1
pTAE_sup=Nradial-2*radial_bin_size

radial_bins=[radial_bin_half_size+1:radial_bin_size:Nradial-radial_bin_size+1]';
...
% 	averaged_cross_section=1.1*(1e-24)*(Ti_psi/1000)^2;
    averaged_cross_section=sigma_v_bosch_hale;
    Salpha=0.25*Ni0_psi*Ni0_psi*averaged_cross_section(radial_bins(psi_pos));
