...
plot(time_scale_G(1:end_time),pphi_outputG(P5,1:end_time),'k--','LineWidth',2);
...
plot(time_scale_G(1:end_time),pphi_outputG(P6,1:end_time),'k--','LineWidth',2);
xlabel('time (s)');
ylabel('p_\phi');
xlim([0 time_end]);
...
plot(time_scale_G(time0:end_time),rhoL_outputG(P2,time0:end_time),'Color',[0.1 0.1 0.6],'LineWidth',1.5);
plot(time_scale_G(time0:end_time),rhoL_outputG(P5,time0:end_time),'--','Color',[0.2 0.8 0.2],'LineWidth',1.5);
plot(time_scale_G(time0:end_time),rhoL_outputG(P6,time0:end_time),'--','Color',[0.8 0.2 0.2],'LineWidth',1.5);
xlabel('time (s)')
ylabel('\rho_L (m)');
% xlim([time_scale_G(1) time_scale_G(end-1)])
xlim([0 time_end]);
...
plot(time_scale_G(time0:end_time),0.5*(mHe/eV)*vparallel_outputG(P2,time0:end_time).^2+Eperp_outputG(P2,time0:end_time),'Color',[0.1 0.1 0.6],'LineWidth',1.5);
plot(time_scale_G(time0:end_time),0.5*(mHe/eV)*vparallel_outputG(P5,time0:end_time).^2+Eperp_outputG(P5,time0:end_time),'Color',[0.2 0.8 0.2],'LineWidth',1.5);
plot(time_scale_G(time0:end_time),0.5*(mHe/eV)*vparallel_outputG(P6,time0:end_time).^2+Eperp_outputG(P6,time0:end_time),'Color',[0.8 0.2 0.2],'LineWidth',1.5);
xlabel('time (s)');
ylabel('Ekin (eV)');
% xlim([time_scale_G(1) time_scale_G(end-1)])
xlim([0 time_end]);
