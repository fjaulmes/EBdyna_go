...
build_radial_alpha_particles_binning_MB_W;
...
% % NIMP_profile_radial_ini=interp1((0:Nradial-1)/(Nradial-1),NIMP_profile_interp_ini,rho_tor_scale);
% 
% 
...
%             end
    ...
    FILENAME=strcat('initial_alphas_MB_W_distribution',num2str(PROCESS_NUMBER),'.mat')
