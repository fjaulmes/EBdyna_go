clear all;
build_radial_profiles_fusion_cross_section;

build_radial_alpha_particles_binning_bosch_hale;
...
%         
    ...
    adjust_init_kinetic_alphas_density_profile
    % figure(1);
    % axis xy square
    % hold on
    %
    ...
    FILENAME=strcat('initial_alphas_bh_distribution',num2str(PROCESS_NUMBER),'.mat')
    save (FILENAME,'density_part_ratio','particles_weight','frac_fusion','alphas_pos_x','alphas_pos_z','alphas_pos_phi','alphas_Ekin','alphas_mm','alphas_vpll','Nalphas_simulated');
