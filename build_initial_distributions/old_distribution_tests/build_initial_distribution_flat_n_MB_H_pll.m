...
X_min=X1_Nradial(round(psi_rank_max+0.3*X_bin_size));
...
for PROCESS_NUMBER=1:16
    ...
    FILENAME=strcat(EQ_FOLDER,'initial_MBH_',num2str(MB_TEMP),'_f_distribution',num2str(PROCESS_NUMBER),'.mat')
