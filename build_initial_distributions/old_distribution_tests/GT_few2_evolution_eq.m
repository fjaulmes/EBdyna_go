...
h=DELTA_TIME;
NB_TIME_STEPS=round(0.02*(tau_cr/FAST_SAWTOOTH)/DELTA_TIME)
...
EVOLVE_VEXB=1;
USE_LAP_PSI=0;
SAVENAME=strcat('few_particles_eq_G080413_h',num2str(TPRECISE))
...
alphas_pos_z=[-0.38 -0.2 -0.05 -0.02 0.02 0.05 0.2 0.38 -0.26 -0.2 -0.12 -0.02 0.02 0.12 0.2 0.26 0.22 0.22 0.22 0.22 0.22 0.22 0.22 0.22 -0.02 0.02  0 0 -0.2 -0.2 0.2 0.2];
