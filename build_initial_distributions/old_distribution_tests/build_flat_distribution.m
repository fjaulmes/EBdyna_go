...
for X_bin_rank=1:N_X_bins
    volume_bin(psi_rank,X_bin_rank)=sum(sum(volume_tor_diff(1:psi_rank_max,X_bin_pos_remap(X_bin_rank)-X_bin_half_std:X_bin_pos_remap(X_bin_rank)+X_bin_half_std-1)));
end
...
FILENAME=strcat(EQ_FOLDER,'initial_flat_distribution.mat')
