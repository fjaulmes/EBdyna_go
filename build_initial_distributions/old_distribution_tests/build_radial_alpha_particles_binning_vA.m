...
%making no assumptions on the effecive charge of the ions
Zeff=1.0;

% arbitrary alphas density, here independent of BETA_ALPHAS
frac_fusion=0.001;
...
%     Ne0=4*10^19;
    ...
    Te_psi=TE_FRAC*Pvalues(psi_pos)/Ne0_psi/eV  %eV
    Ti_psi=TE_FRAC*Pvalues(psi_pos)/((1/Zeff)*Ne0_psi)/eV; %eV
