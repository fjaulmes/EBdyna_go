...
%         pause
    ...
    particles_weight=particles_weight*density_on_axis/nTAE_initial_profile(PSI_BIN_SIZE+1)
%     density_part_ratio=density_part_ratio*density_on_axis/nTAE_initial_profile(PSI_BIN_SIZE+1)
    
    FILENAME=strcat('../particles_equilibrium/initial_MB_H200_TAE_distribution_test.mat')
    save (FILENAME,'particles_weight','alphas_pos_x','alphas_pos_z','alphas_pos_phi','alphas_Ekin','alphas_mm','alphas_vpll','Nalphas_simulated');
