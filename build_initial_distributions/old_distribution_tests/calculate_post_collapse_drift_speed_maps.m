...
simulation_size_r=212;
mid_Xaxis_large=mid_X_large+round(X_axis/DX);


minX=max(mid_X_large-round(1.65*simulation_size_r),3);
maxX=min(mid_X_large+round(1.55*simulation_size_r),NZ-2);
minZ=max(mid_Z-round(1.4*elongation*simulation_size_r),3);
maxZ=min(mid_Z+round(1.4*elongation*simulation_size_r),NZ-2);
...
save (FILENAME,'bX_XZ_map','bZ_XZ_map','bphi_XZ_map','size_X','size_Z','Btot_XZ_map','Bphi_XZsmall_map','BpolX_final_XZsmall_map','BpolZ_final_XZsmall_map','Rpos_XZsmall_map','radial_XZsmall_map','theta_XZsmall_map','psiH_XZsmall_map','psi_norm_XZsmall_map','psi_XZsmall_map','psi_global');
