...
if exist('METISdata')
    N_profile_radial_ini=interp1(METISdata.rho_tor_metis,METISdata.nZ_profile,rho_tor_scale);
    ...
    C_density_profile=N_profile_radial_ini;
    Ti_profile=interp1(OMFITdata.rho_profile_Te,OMFITdata.Ti_values,rho_pol_scale);
 else
    CORE_ROTATION=1.2e5;
    C_density_profile=(Ne_profile/Ne_profile(1)).^3;
end


% plot(radial_r_value_flux,C_density_profile)

filename=strcat(DATA_FOLDER,'C_profile.mat');
save (filename,'C_density_profile','Ti_profile','mHe','mC','ZHe','ROTATION_profile_radial_ini','CORE_ROTATION');
