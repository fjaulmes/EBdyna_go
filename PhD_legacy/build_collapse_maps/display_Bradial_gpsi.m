...
Bstar_data=reshape((Bstar_radial_phi1.*gradr_psi_map)',sizeX*sizeZ,1);
Bstar1_radial_PR_map=griddata(X_scale_data,Z_scale_data,Bstar_data,RR,Z_PR_map(:,1:size_r),'cubic');

Bstar_data=reshape((Bstar_radial_phi2.*gradr_psi_map)',sizeX*sizeZ,1);
Bstar2_radial_PR_map=griddata(X_scale_data,Z_scale_data,Bstar_data,RR,Z_PR_map(:,1:size_r),'cubic');
...
set(gca,'FontSize',26);
hold on
imagesc(scale_X,scale_Z ,(psi_XZ_map1)',-[7 0]*1e-3);
...
set(gca,'FontSize',26);
hold on
imagesc(scale_X,scale_Z , (psi_XZ_map2)',-[7 0]*1e-3);
contour(scale_X_small,scale_Z_small,theta_map',20,'k')
contour(scale_X_small,scale_Z_small,psi_map',20,'k')
colormap(flipud(gray))
xlim([-0.35 0.5])
...
set(gca,'FontSize',26);
hold on
imagesc(scale_X,scale_Z ,(Bstar_radial_phi1.*gradr_psi_map)',[-0.03 0.03]);
% contour(scale_X_small,scale_Z_small,theta_map',20,'k')
% contour(scale_X_small,scale_Z_small,psi_map',20,'k')
QUIV_FACTOR=29;
...
set(gca,'FontSize',26);
hold on
imagesc(scale_X,scale_Z , (Bstar_radial_phi2.*gradr_psi_map)',[-0.03 0.03]);
QUIV_FACTOR=29;
quiver(scale_X(1:QUIV_FACTOR:end),scale_Z(1:QUIV_FACTOR:end),...
