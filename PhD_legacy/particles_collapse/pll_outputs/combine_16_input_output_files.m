...
SAVENAME='../initial_NBI_1MEV_D_pre_collapse_all.mat'

n=1;
INPUTNAME=strcat('initial_NBI_1MEV_D_pre_collapse',num2str(n),'.mat')
load(INPUTNAME)
...
save(SAVENAME,'Nalphas_simulated','alphas_Ekin', 'alphas_mm', 'alphas_pphi0', 'alphas_pos_x', 'alphas_pos_z', 'alphas_pos_phi', 'alphas_vpll', 'alphas_psi', 'v_X', 'v_Z', 'v_phi');



%%
% precession stats
SAVENAME='../initial_NBI_1MEV_D_precession_stats_all.mat'

n=1;
INPUTNAME=strcat('initial_NBI_1MEV_D_precession_stats',num2str(n),'.mat')
load(INPUTNAME)
r_avg=r_avg';
...
SAVENAME='../NBI_1MEV_fc0p5h2_all.mat'

n=1;
INPUTNAME=strcat('NBI_1MEV_fc0p5h2_',num2str(n),'.mat')
load(INPUTNAME)
