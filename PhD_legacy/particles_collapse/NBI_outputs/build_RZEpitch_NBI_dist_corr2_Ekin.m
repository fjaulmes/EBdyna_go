...
alphas_weight=alphas_weight1.*alphas_weight2;
...
alphas_weight_radial_profile3=interp1(rho_lin_scale,alphas_weight_rho_profile_new,rho_tor_scale);

alphas_weight_radial_profile3(1:15)=0.5*(alphas_weight_radial_profile3(1:15)+1)
alphas_weight_radial_profile3(1:35)=min(alphas_weight_radial_profile3(1:35),1.01);
alphas_weight_radial_profile3(end-25:end)=min(alphas_weight_radial_profile3(end-25:end),1.1);
...
save weight_correction_profileP.mat radial_r_value_flux alphas_weight_radial_profile1 alphas_weight_radial_profile2 alphas_weight_radial_profile3 
...
plot(rho_tor_scale(1:round(1.4*size_r)),alphas_weight_radial_profile3(1:round(1.4*size_r)))

plot(rho_tor_scale,alphas_weight_radial_profile_old,'b--')
plot(rho_tor_scale,alphas_weight_radial_profile3)

weight_poly=polyfit(rho_tor_scale(1:round(1.5*size_r)),alphas_weight_radial_profile3(1:round(1.5*size_r)),4);
alphas_weight_radial_profile_new=polyval(weight_poly,rho_tor_scale);
plot(rho_tor_scale,alphas_weight_radial_profile_new,'r')

alphas_weight_radial_profile_adjust=0.5*(alphas_weight_radial_profile_new+alphas_weight_radial_profile3);
alphas_weight_radial_profile3=0.5*(1+alphas_weight_radial_profile_new);
% alphas_weight_radial_profile=alphas_weight_radial_profile_new;
alphas_weight_radial_profile3(1:55)=min(alphas_weight_radial_profile3(1:55),1.01);
alphas_weight_radial_profile3(end-55:end)=min(alphas_weight_radial_profile3(end-55:end),1.1);
...
plot(rho_tor_scale,alphas_weight_radial_profile3,'g')
