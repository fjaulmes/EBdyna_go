...
alphas_weight_radial_profile_old=alphas_weight_radial_profile1;
alphas_weight=interp1(radial_r_value_flux,alphas_weight_radial_profile1,r_avg);
...
Z_BIN_SIZE=0.05;
Z_BINS=(-0.84:Z_BIN_SIZE:0.84);
Z_values=Z_BINS(1:end-1)+0.5*Z_BIN_SIZE;

RADIAL_BIN_SIZE=0.04;
...
FILENAME_INI='dist_NBI_Pcorr_AUG30382_2p9_EpitchRZ_ini.dat'
FILENAME_END='dist_NBI_Pcorr_AUG30382_2p9_EpitchRZ_160_end.dat'
...
% 
% 
% load('NBI60kev_fc1p6h1p6_all.mat');
...
alphas_weight_radial_profile2=interp1(rho_lin_scale,alphas_weight_rho_profile_new,rho_tor_scale);

alphas_weight_radial_profile2(1:15)=0.5*(alphas_weight_radial_profile2(1:15)+1)
alphas_weight_radial_profile2(1:35)=min(alphas_weight_radial_profile2(1:35),1.1);
alphas_weight_radial_profile2(end-35:end)=min(alphas_weight_radial_profile2(end-35:end),1.2);
...
save weight_correction_profileP.mat radial_r_value_flux alphas_weight_radial_profile1 alphas_weight_radial_profile2
...
plot(rho_tor_scale(1:round(1.4*size_r)),alphas_weight_radial_profile2(1:round(1.4*size_r)))

plot(rho_tor_scale,alphas_weight_radial_profile_old,'b--')
plot(rho_tor_scale,alphas_weight_radial_profile2)

weight_poly=polyfit(rho_tor_scale(1:round(1.5*size_r)),alphas_weight_radial_profile2(1:round(1.5*size_r)),4);
alphas_weight_radial_profile_new=polyval(weight_poly,rho_tor_scale);
plot(rho_tor_scale,alphas_weight_radial_profile_new,'r')

alphas_weight_radial_profile_adjust=0.5*(alphas_weight_radial_profile_new+alphas_weight_radial_profile2);
alphas_weight_radial_profile2=0.5*(1+alphas_weight_radial_profile_new);
% alphas_weight_radial_profile=alphas_weight_radial_profile_new;
alphas_weight_radial_profile2(1:25)=min(alphas_weight_radial_profile2(1:25),1.1);
alphas_weight_radial_profile2(end-35:end)=min(alphas_weight_radial_profile2(end-35:end),1.1);

% alphas_weight_radial_profile(1:15)=alphas_weight_radial_profile_adjust(1:15);
save weight_correction_profileP.mat radial_r_value_flux alphas_weight_radial_profile1 alphas_weight_radial_profile2
% alphas_weight_radial_profile=alphas_weight_radial_profile_adjust;

plot(rho_tor_scale,alphas_weight_radial_profile2,'g')
