...
RECORD_TS=0.01*NB_TIME_STEPS;

%simulation options
SAVE_DATA_FILE=1;
CALCULATE_TRUE_PPHI=0;

MIN_ALPHAS_EKIN=1000;


%PROCESS_VAL=(round(PROCESS_NUMBER)-0.5)*10

INPUTFILE=strcat('initial_W40_pre_collapse',num2str(PROCESS_NUMBER),'.mat')
