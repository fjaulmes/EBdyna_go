...
SAVENAME='initialG_NBI60keV_tD_pre_collapse.mat'

load('initialG_NBI60keV_t1_D_pre_collapse.mat')
...
load('initialG_NBI60keV_t2_D_pre_collapse.mat')
...
alphas_Ekin=[alphas_Ekin_p1 ; alphas_Ekin_p2 ];
alphas_mm=[alphas_mm_p1 ; alphas_mm_p2 ];
alphas_pphi0=[alphas_pphi0_p1 ; alphas_pphi0_p2 ];
alphas_pos_x=[alphas_pos_x_p1 ; alphas_pos_x_p2 ];
alphas_pos_z=[alphas_pos_z_p1 ; alphas_pos_z_p2 ];
alphas_pos_phi=[alphas_pos_phi_p1 ; alphas_pos_phi_p2 ];
alphas_vpll=[alphas_vpll_p1 ; alphas_vpll_p2 ];
alphas_psi=[alphas_psi_p1 ; alphas_psi_p2 ];
v_X=[v_X_p1 ; v_X_p2 ];
v_Z=[v_Z_p1 ;v_Z_p2 ];
v_phi=[v_phi_p1 ; v_phi_p2 ];
...
%%
% precession stats
SAVENAME='initialG_NBI60keV_tD_precession_stats.mat'

load('initialG_NBI60keV_t1_D_precession_stats.mat')
...
load('initialG_NBI60keV_t2_D_precession_stats.mat')
...
r_avg=[r_avg_p1 ; r_avg_p2 ];
q_avg=[q_avg_p1 ; q_avg_p2 ];
alphas_kappa=[alphas_kappa_p1 ; alphas_kappa_p2 ];
alphas_lambda=[alphas_lambda_p1 ; alphas_lambda_p2];
ALL_TRAPPED_POP=[ALL_TRAPPED_POP_p1 ; ALL_TRAPPED_POP_p2 ];
ALL_PASSING_POP=[ALL_PASSING_POP_p1 ; ALL_PASSING_POP_p2 ];
TRAPPED_MINUS_POP=[TRAPPED_MINUS_POP_p1 ; TRAPPED_MINUS_POP_p2];
TRAPPED_PLUS_POP=[TRAPPED_PLUS_POP_p1 ; TRAPPED_PLUS_POP_p2 ];
POTATOES_POP=[POTATOES_POP_p1 ; POTATOES_POP_p2 ];
STAGNATION_POP=[STAGNATION_POP_p1 ;STAGNATION_POP_p2 ];
CO_PASSING_POP=[CO_PASSING_POP_p1 ; CO_PASSING_POP_p2 ];
COUNTER_PASSING_POP=[COUNTER_PASSING_POP_p1 ; COUNTER_PASSING_POP_p2 ];
omega_ik_avg_p3=[omega_ik_avg_p1 ; omega_ik_avg_p2 ];
omega_psi_avg=[omega_psi_avg_p1 ; omega_psi_avg_p2 ];
r_vpll_minus_avg=[r_vpll_minus_avg_p1 ; r_vpll_minus_avg_p2 ];
r_vpll_plus_avg=[r_vpll_plus_avg_p1 ; r_vpll_plus_avg_p2 ];
omega_r_avg=[omega_r_avg_p1 ; omega_r_avg_p2 ];
delta_r_avg=[delta_r_avg_p1 ; delta_r_avg_p2 ];
omega_precess_avg=[omega_precess_avg_p1 ; omega_precess_avg_p2 ];
omega_bounce=[omega_bounce_p1 ; omega_bounce_p2 ];
phidot_avg=[phidot_avg_p1 ; phidot_avg_p2 ];
...
SAVENAME='NBI60keV_tD_collapse_Glisa_fc2h2_G080414.mat'

load('NBI60keV_t1_D_collapse_Glisa_fc2h2_G080414.mat');
alphas_Ekin_p1=alphas_Ekin;
alphas_mm_p1=alphas_mm;
alphas_pphi0_p1=alphas_pphi0;
alphas_pos_x_p1=alphas_pos_x;
...
load('NBI60keV_t2_D_collapse_Glisa_fc2h2_G080414.mat')
alphas_Ekin_p2=alphas_Ekin;
alphas_mm_p2=alphas_mm;
alphas_pphi0_p2=alphas_pphi0;
alphas_pos_x_p2=alphas_pos_x;
...
v_Z=[v_Z_p1 ;v_Z_p2 ];
v_phi=[v_phi_p1 ; v_phi_p2 ];
alphas_ejected=[alphas_ejected_p1 ; alphas_ejected_p2];
alphas_vE_sq=[alphas_vE_sq_p1 ; alphas_vE_sq_p2 ];
alphas_psi_value_corr=[alphas_psi_value_corr_p1 ; alphas_psi_value_corr_p2 ];
alphas_grad_Phi=[alphas_grad_Phi_p1 ; alphas_grad_Phi_p2 ];
alphas_omega=[alphas_omega_p1 ; alphas_omega_p2 ];
alphas_Etot=[alphas_Etot_p1 ; alphas_Etot_p2 ];
pos_X_gc=[pos_X_gc_p1 ; pos_X_gc_p2 ];
pos_Z_gc=[pos_Z_gc_p1 ; pos_Z_gc_p2 ];
