...
%%
load('initial_flatD_85keV_pre_collapse.mat');
load('initial_flatD_85keV_precession_stats.mat');
X0=alphas_pos_x;
Z0=alphas_pos_z;

alphas_theta_ini=interp2(scale_X,scale_Z,theta_XZsmall_map',alphas_pos_x,alphas_pos_z,'*linear');
alphas_Bfield_ini=interp2(scale_X,scale_Z,Btot_XZ_map',alphas_pos_x,alphas_pos_z,'*linear');
alphas_Eperp_ini=alphas_mm.*alphas_Bfield_ini;
alphas_Epll_ini=alphas_Ekin-alphas_Eperp_ini;
...
load('flatD_85keV_fc2h2.mat');
alphas_theta_end=interp2(scale_X,scale_Z,theta_XZsmall_map',alphas_pos_x,alphas_pos_z,'*linear');
alphas_Bfield_end=interp2(scale_X,scale_Z,Btot_XZ_map',alphas_pos_x,alphas_pos_z,'*linear');
alphas_Eperp_end=alphas_mm.*alphas_Bfield_end;
alphas_Epll_end=alphas_Ekin-alphas_Eperp_end;
...
binXlims=(-1.2:0.1:1.8);
binZlims=(-1.5:0.1:1.5);
