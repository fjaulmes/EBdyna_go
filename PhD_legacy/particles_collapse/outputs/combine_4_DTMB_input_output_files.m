...
load('initialG_DT_MB1_pre_collapse.mat')
...
load('initialG_DT_MB2_pre_collapse.mat')
...
load('initialG_DT_MB3_pre_collapse.mat')
...
load('initialG_DT_MB4_pre_collapse.mat')
...
load('initialG_DT_MB1_precession_stats.mat')
...
load('initialG_DT_MB2_precession_stats.mat')
...
load('initialG_DT_MB3_precession_stats.mat')
...
load('initialG_DT_MB4_precession_stats.mat')
...
SAVENAME='DT_MBall_collapse_Glisa_fc1h2_G110414.mat'

load('DT_MB1_collapse_Glisa_fc1h2_G110414.mat');
alphas_Ekin_p1=alphas_Ekin;
alphas_mm_p1=alphas_mm;
alphas_pphi0_p1=alphas_pphi0;
alphas_pos_x_p1=alphas_pos_x;
...
load('DT_MB2_collapse_Glisa_fc1h2_G110414.mat')
alphas_Ekin_p2=alphas_Ekin;
alphas_mm_p2=alphas_mm;
alphas_pphi0_p2=alphas_pphi0;
alphas_pos_x_p2=alphas_pos_x;
...
load('DT_MB3_collapse_Glisa_fc1h2_G110414.mat')
...
load('DT_MB4_collapse_Glisa_fc1h2_G110414.mat')
