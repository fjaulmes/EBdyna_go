...
load('alphas_lowEkin_collapse_Glocal_fc1h2_G150813.mat')
Npsi=histc(alphas_psi,psi_bin_pos);
...
load('alphas_collapse_Glocal_fc1h2_G150813.mat');
...
subplot(3,1,3)
POPULATION_RANGE=ALL_PASSING_POP.*(alphas_Ekin>EKIN_INF);
ENERGY_POPULATION_0=find(POPULATION_RANGE);
ENERGY_POPULATION=find((~alphas_ejected).*POPULATION_RANGE);
