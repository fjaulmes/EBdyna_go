function interp_values=interp2_psi_star_map(scale_psi,scale_omega,FXZ_map,Dpsi,Domega,alphas_pos_psi,alphas_pos_omega,varargin)

if isempty(varargin)
    PART_LIST=(1:length(INDEX_LIST_1));
else
