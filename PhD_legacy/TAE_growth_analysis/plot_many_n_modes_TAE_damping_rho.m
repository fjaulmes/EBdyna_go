...
for n=2:2:MAXNPLOT
    ...
    plot(rho_TAE,gamma_radiative_ini_v2_noF(n,:),'color',[0.2 .2 1.0]*n/MAXNPLOT,'linewidth',2);
    %     plot(rTAE,drive_TAE_ini(n,:)./w_TAE_ini(n,:),'color',[0.1 .1 1.0]*n/40,'linewidth',2);
end
title('before sawtooth')

% plot(rho_TAE,ion_damping_TAE_ini(n,:)./w_TAE_ini(n,:)+e_damping_TAE_ini(n,:)./w_TAE_ini(n,:)+gamma_radiative_ini_noF(n,:)+drive_TAE_ini(n,:)./w_TAE_ini(n,:),'color',[0.4 .4 1.0]*n/MAXNPLOT,'linewidth',4);
...
for n=2:2:MAXNPLOT
    ...
    plot(rho_TAE,gamma_radiative_end_v2_noF(n,:),'color',[1.0 .1 0.1]*n/MAXNPLOT,'linewidth',2);
%     plot(rTAE,drive_TAE_end(n,:)./w_TAE_end(n,:),'color',[1.0 .1 0.1]*n/40,'linewidth',2);
end

% plot(rho_TAE,ion_damping_TAE_end(n,:)./w_TAE_end(n,:)+e_damping_TAE_end(n,:)./w_TAE_end(n,:)+gamma_radiative_end_noF(n,:)+drive_TAE_end(n,:)./w_TAE_end(n,:),'color',[1.0 .4 0.4]*n/MAXNPLOT,'linewidth',4);
