...
e_damping_TAE_ini=zeros(NMAX,MMAX)
...
for n=2:NMAX
    for mindex=1:MMAX
        ...
        e_damping_TAE_ini(n,mindex)=gamma_TAE;
        w_TAE_ini(n,mindex)=wTAE;
    end
end

save ITER_hbeta_m_e_damping_amplitude.mat e_damping_TAE_ini e_damping_TAE_end w_TAE_ini w_TAE_end

%%

figure(3)
set(gca,'fontsize',18)
imagesc((1:MMAX)-0.5,(1:NMAX),e_damping_TAE_end./w_TAE_end-e_damping_TAE_ini./w_TAE_ini)
...
figure(4)
set(gca,'fontsize',18)
imagesc((1:MMAX)-0.5,(1:NMAX),abs(e_damping_TAE_end./w_TAE_end))
set(gca,'XTick',[0.5:1:7.5])
colorbar
