...
plot(rho_scale(round(psi_bin_pos+0.5*radial_bin_size)),density_radial_ini/max(density_radial_ini),'b--','LineWidth',3);
plot(rho_scale(round(psi_bin_pos+0.5*radial_bin_size)),density_radial_end/max(density_radial_ini),'r','LineWidth',3);
...
xlim([0.05 0.6])
ylim([0.1 1])
hl=legend('initial','post collapse');
set(hl,'fontsize',22)
