...
% load('initial_MBD_300_pre_collapse_super_light.mat','alphas_weight','alphas_Ekin','alphas_mm','alphas_vpll')
% load('initial_MB_H150_precession_stats_all.mat')
load('initial_MB_H400_precession_stats_all.mat')
load('initial_MB_H400_pre_collapse_all.mat','alphas_weight','alphas_Ekin','alphas_mm','alphas_vpll','pos_X_gc','pos_Z_gc')
...
plot([-0.2 0.2],(omega_TAE/nTAE)*[-0.2 0.2],'k--')
...
hl=legend(strcat('$\Delta \mathcal{E} _{\rm{trapped}} = 1.4 \ \rm{J}$'),...
    strcat('$\Delta \mathcal{E} _{\rm{potatoes}} = -0.0001 \ \rm{J}$'),...
    strcat('$\Delta \mathcal{E} _{\rm{counter-passing}} = -2.3 \ \rm{J}$'),...
    strcat('$\Delta \mathcal{E} _{\rm{co-passing}} = -5.4 \ \rm{J}$'),...
    strcat('$\Delta \mathcal{E} _{\rm{stagnation}} = -2.1 \ \rm{J}$'),...
...
VPLLBINSIZE=0.04
vpll_bins=(-1.8:VPLLBINSIZE:1.8)*1e7;
