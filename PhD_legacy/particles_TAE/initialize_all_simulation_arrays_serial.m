...
%     PART_POP_TAE=find((abs(alphas_pphi0)<20).*(abs(alphas_pphi0)>14).*(alphas_psi<0.9*pTAE_sup));
    ...
    PART_POP_TAE=PART_POP_TAE(1:40000);
...
Xpos_part_output=zeros(NB_TIME_STAMPS,Nalphas_simulated);
...
Ekin_gc_output=zeros(NB_TIME_STAMPS,Nalphas_simulated);
...
mm_output=zeros(NB_TIME_STAMPS,Nalphas_simulated);
Etot_output=zeros(NB_TIME_STAMPS,Nalphas_simulated);
part2wave_power_output=zeros(NB_TIME_STAMPS,Nalphas_simulated);
part2wave_vD_power_output=zeros(NB_TIME_STAMPS,Nalphas_simulated);
