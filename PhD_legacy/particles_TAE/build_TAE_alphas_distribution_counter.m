...
load('initialG_TAE_n8m9_1_pre_collapse.mat')
load('initialG_TAE_n8m9_1_precession_stats')
r_avg=r_avg';

alphas_Ekin=real(alphas_Ekin);
alphas_mm=max(alphas_mm,0);

rinf=interp1(1:Nradial,radial_r_value_flux,0.9*pTAE_inf)
rsup=interp1(1:Nradial,radial_r_value_flux,1.1*pTAE_sup)

PART_POP_TAE=find((r_avg>=rinf).*(r_avg<=rsup).*COUNTER_PASSING_POP.*(abs(alphas_vpll)<1.2e7));
...
r_avg01=r_avg(PART_POP_TAE);

Nalphas_simulated1=length(alphas_vpll1)



load('initialG_TAE_n8m9_2_pre_collapse.mat')
load('initialG_TAE_n8m9_2_precession_stats')
r_avg=r_avg';
...
r_avg02=r_avg(PART_POP_TAE);

Nalphas_simulated2=length(alphas_vpll2)



load('initialG_TAE_n8m9_3_pre_collapse.mat')
load('initialG_TAE_n8m9_3_precession_stats')
r_avg=r_avg';
...
load('initialG_TAE_n8m9_4_pre_collapse.mat')
load('initialG_TAE_n8m9_4_precession_stats')
r_avg=r_avg';
...
load('initialG_TAE_n8m9_5_pre_collapse.mat')
load('initialG_TAE_n8m9_5_precession_stats')
r_avg=r_avg';
...
load('initialG_TAE_n8m9_6_pre_collapse.mat')
load('initialG_TAE_n8m9_6_precession_stats')
r_avg=r_avg';
...
load('initialG_TAE_n8m9_7_pre_collapse.mat')
load('initialG_TAE_n8m9_7_precession_stats')
r_avg=r_avg';
...
load('initialG_TAE_n8m9_8_pre_collapse.mat')
load('initialG_TAE_n8m9_8_precession_stats')
r_avg=r_avg';
...
r_avg=[r_avg01 ; r_avg02 ; r_avg03 ; r_avg04 ; r_avg05 ; r_avg06 ; r_avg07 ; r_avg08];
...
save('initialG_alphas_TAE_counter_n8m9.mat', 'mHe', 'ZHe', 'density_part_ratio', 'Nalphas_simulated', ...
'alphas_pos_x', 'alphas_pos_z', 'alphas_pos_phi', 'alphas_Ekin', ...
'alphas_mm', 'alphas_vpll', 'alphas_psi', 'v_X', 'v_Z', 'v_phi', 'alphas_pphi0','r_avg');
