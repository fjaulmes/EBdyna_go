...
alphas_Bfield(INNER_PART)=interp3_phi_theta_psi(scale_theta,scale_phi,(1:size_r),Btot_map_phi,alphas_theta,alphas_pos_phi_TAE,alphas_psi,INNER_PART);
...
bX(INNER_PART)=interp3_phi_theta_psi(scale_theta,scale_phi,(1:size_r),BsX_map_phi,alphas_theta,alphas_pos_phi_TAE,alphas_psi,INNER_PART);
bZ(INNER_PART)=interp3_phi_theta_psi(scale_theta,scale_phi,(1:size_r),BsZ_map_phi,alphas_theta,alphas_pos_phi_TAE,alphas_psi,INNER_PART);
