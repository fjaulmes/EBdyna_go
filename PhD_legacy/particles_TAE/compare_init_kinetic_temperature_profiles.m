...
alphas_pos_psi=psi_value_output(1,:);
alphas_Ekin=Ekin_output(1,:);


alphas_psi=interp1(psi_scale,1:Nradial,alphas_pos_psi);
...
nD_initial_profile=interp1(psi_bins_pos,nD,1:Nradial);
...
% 
P_D_initial_profile=nD_initial_profile.*Ti_D_initial_profile*eV;
