...
rinf=interp1(1:Nradial,radial_r_value_flux,0.8*pTAE_inf)
rsup=interp1(1:Nradial,radial_r_value_flux,1.2*pTAE_sup)

PART_POP_TAE=find((r_avg>=rinf).*(r_avg<=rsup).*ALL_TRAPPED_POP.*(abs(alphas_vpll)<1.2e7));
...
save('initialG_alphas_TAE_trapped_n8m9.mat', 'mHe', 'ZHe', 'density_part_ratio', 'Nalphas_simulated', ...
