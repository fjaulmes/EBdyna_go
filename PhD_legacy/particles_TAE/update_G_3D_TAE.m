...
%v_slope=(v_phi-v_phi_prev_prev)/4;
%v_phi_tilde=v_phi_prev+v_slope;
v_phi_tilde=0.5*(v_phi+v_phi_prev);


% now do the time step iteration
% with more accurate vphi time step value
