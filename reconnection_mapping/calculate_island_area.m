...
area_region1=interp1(1:NR,surf_flux_precise(1,1:NR)',x_nu_cont13_initial,'pchip');
area_region2=interp1(1:NR,surf_flux_precise(1,1:NR)',pos_psi_rx,'pchip');
%area_region3=interp1(1:size_r,surf_flux(1,1:size_r)',x_psi_final_rx,'pchip');

area_region3=area_region2-area_region1
x_psi_final_rx=interp1(surf_flux_precise(1:NR),(1:NR),area_region3,'pchip');