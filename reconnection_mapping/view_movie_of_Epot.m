...
%     psi_star_2D(:,:)=psi_star_2D_evol(f+1,:,:)-psi_star_2D_evol(f-1,:,:);
    ...
    cla(sp);
    imagesc((-0.5:0.001:0.5),(0:0.001:0.5),psi_XY_map',[-0.37 0.01]*1e-2);
    axis xy;
%     surfc(XX,YY,psi_star_2D,'edgecolor','none');view(0,90);
    xlim([-RADIAL_DISPLAY_SIZE RADIAL_DISPLAY_SIZE])
    ylim([0 RADIAL_DISPLAY_SIZE])
...
%     
    ...
    cla(sp);
    imagesc((-0.5:0.001:0.5),(0:0.001:0.5),Epot_XY_map',[-0.8 0.8]*1e3);
    axis xy;
