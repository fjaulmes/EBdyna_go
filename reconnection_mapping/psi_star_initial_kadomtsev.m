...
grid on;
hold on;
%plot(r_bar_rho,Q_profile_interp_ini,'g','LineWidth',1.5);
...
legend('TRANSP','EBdyna before collapse','EBdyna after collapse');
...
xPsih_max=interp1(scale_r,1:NR,r_q1,'pchip');
xPsih_zero=interp1(Psih(round(xPsih_max):NR),round(xPsih_max):NR,0,'pchip');
